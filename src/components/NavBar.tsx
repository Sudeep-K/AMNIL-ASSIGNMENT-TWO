    ...
    <Navbar sticky='top' className='bg-white shadow-sm mb-3'>
        <Container>
            ...
            <Button style={{ width: "3rem", height: "3rem", position: "relative" }} variant="outline-primary" className="rounded-circle" onClick={openCart}>
                ...
                <div className='rounded-circle bg-danger d-flex justify-content-center align-items-center' style={{position: "absolute", right: 0, bottom: 0, color: 'white', width: '1.5rem', height: '1.5rem', transform: "translate(25%, 25%)"}}>{quantity}</div>
            </Button>
        </Container>
    </Navbar>
  )
